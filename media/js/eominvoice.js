...
function DefaultColumns(tt)
{
	...
	colArr = [[
				{field:'subform_batch_details_order_id',title:'<b>Order Id</b>',width:140,align:'left',editor:{type:'combobox',options:{valueField:'order_id',textField:'order_id', url:url_orders,onSelect:eominvoice_GetOrderData, mode:'remote',required:true}}},
...
function eominvoice_UpdateDetails()
{
...
function eominvoice_GetOrderData()
{
	var lookupval = "";
	var row = $('#'+subtable).datagrid('getSelected');
