...
CREATE TABLE `devices_is` (
  ...
  `device_status` enum('ACTIVE','RETIRED') NOT NULL DEFAULT 'ACTIVE',
  `warranty_expiry_date` date DEFAULT NULL,
  `passcode` varchar(255) DEFAULT NULL,
...
CREATE TABLE `orders_is` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13617 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pdfs_is` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_pdf_id` (`pdf_id`)
) ENGINE=InnoDB AUTO_INCREMENT=30890 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recordlocks` (
  ...
  `current_no` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7571 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`dbuser`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_device_products` AS (select `products`.`product_id` AS `product_id`,`products`.`product_description` AS `product_description` from `products` where ((`products`.`sub_category` like 'TRACKER%') and (`products`.`status` = 'ACTIVE'))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`dbuser`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_devices_available` AS (select `devices`.`id` AS `id`,`devices`.`device_id` AS `device_id`,`devices`.`model` AS `model`,`devices`.`phone_device` AS `phone_device` from `devices` where (not(`devices`.`device_id` in (select `vehicles`.`device_id` AS `device_id` from `vehicles` where (`vehicles`.`device_id` <> 'NO.DEVICE'))))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2012-07-11 15:53:08
