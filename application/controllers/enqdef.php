...
class Enqdef_Controller extends Site_Controller
{
	...
	function input_validation()
	{
		...
		$validation->add_rules('controller','required', 'length[1,255]', 'standard_text');
		
		$validation->add_callbacks('controller', array($this, '_duplicate_altid'));
