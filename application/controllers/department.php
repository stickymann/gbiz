...
class Department_Controller extends Site_Controller
{
	...
	function input_validation()
	{
		...
		$validation->add_rules('department_id','required', 'length[2,11]', 'standard_text');
		$validation->add_rules('location','required', 'length[2,11]', 'standard_text');
		
		$validation->add_callbacks('department_id', array($this, '_duplicate_altid'));
		//$validation->post_filter('strtoupper', 'department_id_id');
